...
python verl/experimental/vla/fix_libero_dataset_images.py \
  --src /shared_disk/users/angen.ye/code/hil-serl/datasets/LIBERO-dataset/libero_10 \
  --dst /shared_disk/users/angen.ye/code/hil-serl/datasets/LIBERO-dataset/libero_10_fixed \
