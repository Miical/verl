...
EXPERIMENT_NAME="catch_bowl_offline_only_piper50"
...
$PYTHON -m verl.experimental.vla.main_sac \
    ...
    +actor_rollout_ref.model.override_config.rollout_action_steps=50 \
    +actor_rollout_ref.model.override_config.rollout_action_dim=14 \
