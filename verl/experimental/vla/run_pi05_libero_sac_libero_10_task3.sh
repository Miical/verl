...
OUTPUT_DIR=${OUTPUT_DIR:-/shared_disk/users/angen.ye/code/hil-serl/model/verl_fintune_model/libero10_task3_rlpd_smoke}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-libero10_task3_rlpd_smoke}
...
$PYTHON -m verl.experimental.vla.main_sac \
    ...
    actor_rollout_ref.actor.sac.target_entropy=-2.5 
