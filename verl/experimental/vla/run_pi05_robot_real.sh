...
SFT_MODEL_PATH=${SFT_MODEL_PATH:-"$HOME/weight/giga-openpi/pick_catch_bowl_new_yag/1k"}
# SFT_MODEL_PATH=${SFT_MODEL_PATH:-"$HOME/weight/giga-openpi/install_belt_joint/3w"}

# path ：$HOME/weight/giga-openpi/pick_catch_bowl_model 单臂夹碗
