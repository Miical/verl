...
# export TORCH_HOME=/shared_disk/models/torch
# export TRANSFORMERS_CACHE=/shared_disk/models/huggingface
# export HUGGINGFACE_HUB_CACHE=/shared_disk/models/huggingface
# export XDG_CACHE_HOME=/shared_disk/models/xdg
# export HF_DATASETS_CACHE=/shared_disk/models/huggingface/datasets
...
OUTPUT_DIR="/shared_disk/users/angen.ye/code/hil-serl/model/verl_fintune_model/test2"
