...
def add_actor_information_and_train(
    ...
    while True:
        ...
        if online_iterator is None:
            ...
            # online_iterator = replay_buffer.get_iterator(
            #     batch_size=4, async_prefetch=async_prefetch, queue_size=2
            # )
        ...
        if offline_replay_buffer is not None and offline_iterator is None:
            ...
            # offline_iterator = offline_replay_buffer.get_iterator(
            #     batch_size=1020, async_prefetch=async_prefetch, queue_size=2
            # )
        ...
        if optimization_step % log_freq == 0:
            ...
            logging.info(
                f"[LEARNER] step={optimization_step}, "
                f"critic_loss={training_infos.get('loss_critic')}, "
                f"actor_loss={training_infos.get('loss_actor')}, "
                f"temp_loss={training_infos.get('loss_temperature')}"
            )
